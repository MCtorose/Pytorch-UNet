...
% Last Modified by GUIDE v2.5 12-May-2024 00:57:03
...
% --- Executes on button press in gao_tong.
function gao_tong_Callback(hObject, eventdata, handles)
% hObject    handle to gao_tong (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
 axes(handles.axes2);
    global fpath;
